...
// Session recovery, the common provider, and the compact all-node layout add a
// deliberately small amount of startup code. Keep the allowance within 0.5%.
const maximumKiB = 184.5
